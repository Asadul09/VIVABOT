    ...
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
      ...
      >
        <div className='flex items-center gap-3 cursor-pointer'>
          ...
          <h1 className='font-semibold hidden md:block text-lg'>VivaBot</h1>
        </div>
            ...
            {showCreditPopup && (
              <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
                ...
                <button
                  ...
                  className='w-full bg-black text-white py-2 hover:bg-blue-700 transition flex items-center justify-center gap-2 rounded-lg'
                >
                  Buy Credits
                </button>
              </div>
          ...
          <div className='relative'>
            ...
            {showUserPopup && (
              <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                ...
                {/* Buy Credits Button if credits < 50 */}
                {userData?.credits < 50 && (
                  <button
                    onClick={() => navigate('/pricing')}
                    className='w-full text-left text-sm py-2 text-green-600 hover:text-green-800 transition'
                  >
                    Buy Credits
                  </button>
                )}
